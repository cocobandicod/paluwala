...
//import Model "Post"
use App\Models\LowonganPenelitian;
...
class LowonganPenelitianController extends Controller
{
    /**
     * index
     *
    ...
    {
        //get all posts
        $posts = LowonganPenelitian::latest()->get();
    ...
    public function store(Request $request)
    {
        ...
        //create sponsor
        $post = LowonganPenelitian::create([
            'judul'     => $request->judul,
    ...
    {
        //find post by ID
        $post = LowonganPenelitian::find($id);
