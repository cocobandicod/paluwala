        ...
        <div class="col-lg-8">
          <div class="text-center mb-5">
            ...
            <p class="text-muted mb-4">
              Pengumuman Terbaru terkait dengan aturan maupun informasi
            ...
            <div class="accordion-item">
                ...
                <button
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12 pt-2 text-muted">
                      ...
                      {{ formatTanggal(pengumuman.tgl_pengumuman) }}
                      <i class="ri-account-circle-line ms-2 me-1"></i>
              ...
              <div
                ...
                <div class="accordion-body ff-secondary text-black">
                  ...
                  <div class="col-lg-12 pt-2 text-muted">
                    <div v-if="isFileAvailable(pengumuman.file_pengumuman)">
                      <a
                        ...
                        download>
                        <i
                          class="ri-file-download-line label-icon align-middle rounded-pill me-2"></i>
                        Unduh Dokumen
                      </a>
                    </div>
                    <div v-else>
